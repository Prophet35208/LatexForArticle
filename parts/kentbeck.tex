...
\title[TDD + LLM]{Влияние TDD на эффективность использования больших языковых моделей}
\subtitle{Сравнительный анализ подходов разработки с использованием LLM}
\author[]{Гречишкин Е.А., Корниенко В.Р., Таран Д.В., Тихонов И.Е.}
\institute{}
\date{}
